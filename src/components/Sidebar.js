...
import { FaTachometerAlt, FaUsers, FaDownload, FaCoins,  FaShoppingCart,  FaGift } from 'react-icons/fa';
...
const Sidebar = () => {
  ...
  return (
    <div className="bg-dark text-white p-3" style={{ width: '250px', minHeight: '100vh' }}>
      ...
      {/* Toggle submenu */}
      <div className="d-flex align-items-center mb-3" onClick={() => setShowAI(!showAI)} style={{ cursor: 'pointer' }}>
        <FaUsers className="me-2" />
        <span>AI & RI</span>
